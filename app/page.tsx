...
export default function Home() {
  ...
  const [selectedRoom, setSelectedRoom] = useState<string | null>(null); // State to track selected room

  const handleSelectRoom = (roomType: string) => {
    setSelectedRoom(roomType); // Set the selected room
  ...
  return (
    <section className="flex flex-col items-center justify-center gap-4 py-8 md:py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-8 w-full max-w-7xl">
        <RoomCard
          image="https://images.unsplash.com/photo-1666813721996-42956e40788e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxMTc3M3wwfDF8c2VhcmNofDJ8fHJvb218ZW58MHx8fHwxNjYyMjY0NzY0&ixlib=rb-1.2.1&q=80&w=400" // Unsplash image for Deluxe Room
          title="Deluxe Room"
          price="$150/night"
          ...
          isSelected={selectedRoom === "Deluxe Room"} // Pass selected state
        />
        <RoomCard
          image="https://images.unsplash.com/photo-1666813721996-42956e40788e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxMTc3M3wwfDF8c2VhcmNofDJ8fHJvb218ZW58MHx8fHwxNjYyMjY0NzY0&ixlib=rb-1.2.1&q=80&w=400" // Unsplash image for Deluxe Room
          title="Standard Room"
          ...
          isSelected={selectedRoom === "Standard Room"} // Pass selected state
        />
        <RoomCard
          image="https://images.unsplash.com/photo-1666813721996-42956e40788e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxMTc3M3wwfDF8c2VhcmNofDJ8fHJvb218ZW58MHx8fHwxNjYyMjY0NzY0&ixlib=rb-1.2.1&q=80&w=400" // Unsplash image for Deluxe Room
          title="Suite"
          ...
          isSelected={selectedRoom === "Suite"} // Pass selected state
        />
        <RoomCard
          image="https://images.unsplash.com/photo-1666813721996-42956e40788e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxMTc3M3wwfDF8c2VhcmNofDJ8fHJvb218ZW58MHx8fHwxNjYyMjY0NzY0&ixlib=rb-1.2.1&q=80&w=400" // Unsplash image for Deluxe Room
          title="Family Room"
          ...
          isSelected={selectedRoom === "Family Room"} // Pass selected state
        />
      </div>
